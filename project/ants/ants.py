...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while place and i <= self.max_range:
            if place is not hive and place.bees and i >= self.min_range:
        ...
        while place:
            ...
            if ant:
                ...
                if ant.container and ant.ant:
                    in_ant = ant.ant
                    if in_ant not in self.doubled:
                        self.doubled.append(in_ant)
                        in_ant.damage *= 2
            place = place.exit
        "*** YOUR CODE HERE ***"
        # END Problem 13
...
def apply_effect(effect, bee, duration):
    ...
    effect_action = effect(previous_action)
    def action(colony):
        nonlocal duration
