...
def make_to_string(front, mid, back, empty_repr):
    ...
    def mts(lst):
        if lst == Link.empty:
            return empty_repr
        return front + str(lst.first) + mid + mts(lst.rest) + back
    "*** YOUR CODE HERE ***"
    return mts
...
def add_trees(t1, t2):
    ...
    4
      ...
      5
    """
    pairb = list(zip(t1.branches, t2.branches))
    l = len(pairb)
    branches = [add_trees(b1, b2) for b1, b2 in pairb] + t1.branches[l:] + t2.branches[l:]
